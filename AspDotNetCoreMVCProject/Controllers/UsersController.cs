...
namespace AspDotNetCoreMVCProject.Controllers
{
    ...
    {
        private readonly AspDotNetCoreMVCProjectContext _context;

        public UsersController(AspDotNetCoreMVCProjectContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.User != null ? 
                          ...
                          Problem("Entity set 'AspDotNetCoreMVCProjectContext.User'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AspDotNetCoreMVCProjectContext.User'  is null.");
            }
            var user = await _context.User.FindAsync(id);
            if (user != null)
            {
